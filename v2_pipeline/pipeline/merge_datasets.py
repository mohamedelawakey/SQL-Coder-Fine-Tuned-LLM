...
wiki_path = "../../fine tuning data set/train_formatted_v2.jsonl"
spider_path = "../../fine tuning data set/spider_formatted_v2.jsonl"
combined_path = "../../fine tuning data set/combined_train_v2.jsonl"
