...
# Shuffle and balance dataset to 50,000 examples
print("Sampling 50,000 WikiSQL examples...")
sampled_data = cleaned_data.sample(n=50000, random_state=42)
final_data = sampled_data.apply(create_prompt, axis=1).tolist()

output_path = "../../fine tuning data set/wiki_raw_50k.jsonl"
